...
for item in eval_set:
    response = app.invoke({"messages": [{"role": "user", "content": item["question"]}]})
    usage = get_total_usage(response)
    cost = calculate_cost(usage)
    print(f"{item['question'][:50]:50} | tokens: {usage['input_tokens']}+{usage['output_tokens']} | cost: ${cost:.6f}")

"""
--------------------------------------------------------------output---------------------------------------------------------------------

Loading cached embeddings...
What is today's date?                              | tokens: 876+322 | cost: $0.000863
What is 15 plus 27?                                | tokens: 874+166 | cost: $0.000550
What did Barjinder do at Amazon?                   | tokens: 1191+680 | cost: $0.001658
What is Barjinder's favorite food?                 | tokens: 985+427 | cost: $0.001100
What programming languages does Barjinder know?    | tokens: 1036+388 | cost: $0.001035
