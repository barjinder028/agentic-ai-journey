...
Daily log of learning to build AI agents from scratch, on the way to an agentic AI engineering role by the end of 2026. Full day-by-day notes live in [log.md](log.md); this file is just the running list of what got built and what it proved.
