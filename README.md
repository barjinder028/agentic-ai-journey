...
- Day 15: Built a real evaluation set, caught a hidden bug in my own eval code, found the true root cause- Day 15: Built a real evaluation set, caught a hidden bug in my own eval code, found the true root cause